...
#include "controller/ProductConctroller.h"
...
void run(const oatpp::base::CommandLineArguments& args) {
  ...
  docEndpoints.append(router->addController(UsersController::createShared())->getEndpoints());
  docEndpoints.append(router->addController(CategoryController::createShared())->getEndpoints());
  docEndpoints.append(router->addController(ProductController::createShared())->getEndpoints());
